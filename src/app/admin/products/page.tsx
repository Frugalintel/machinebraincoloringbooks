            ...
            {viewMode === 'list' ? (
                                ...
                                <tr key={product.id} className="hover:bg-[#1a1a1a] transition-colors group">
                                    <td className="p-4">
                                        <div className="flex items-center gap-4">
                                            <div className={`w-12 h-12 ${product.color || 'bg-gray-800'} rounded-md flex items-center justify-center relative overflow-hidden`}>
                                                {product.image_url ? (
                                            ...
                                            <div>
                                                ...
                                                <div className="text-xs text-gray-500 font-mono uppercase">{product.subtitle}</div>
                                            </div>
                                        </div>
                                    </td>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-16">
                    ...
                    {filteredProducts.map((product, i) => (
                        <div key={product.id} className="group perspective-1000 flex flex-col">
