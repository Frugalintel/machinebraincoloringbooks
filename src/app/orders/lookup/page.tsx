      ...
      <div className="container mx-auto px-4 md:px-6 py-20 flex flex-col items-center justify-center min-h-[80vh]">
        ...
        <div className="w-full max-w-md">
            <div className="text-center mb-10">
                <h1 className="font-heading text-4xl md:text-5xl font-bold uppercase tracking-tighter mb-4">Order Tracking</h1>
                <p className="text-gray-500 font-mono text-xs uppercase tracking-widest">
                    Enter your order details below to access shipping manifest.
                </p>
            </div>
                ...
                {status === "success" ? (
                    ...
                    >
                        <div className="flex items-center gap-3 text-green-500 mb-4">
                            <CheckCircle size={20} />
                            <span className="font-mono text-sm uppercase tracking-widest">Order Found</span>
                        </div>

                        <div className="space-y-4 border-b border-[#333] pb-6">
                            <div className="flex justify-between items-center">
                                <span className="text-gray-500 text-xs font-mono uppercase">Order ID</span>
                                <span className="text-white font-heading tracking-wide">{orderId || "#ORD-8829"}</span>
                            </div>
                            <div className="flex justify-between items-center">
                            ...
                            <div className="flex justify-between items-center">
                                <span className="text-gray-500 text-xs font-mono uppercase">Est. Delivery</span>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-gray-600 text-xs font-mono">10:00 AM</span>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-gray-600 text-xs font-mono">Local Courier</p>
                                </div>
                    ...
                    >
                        ...
                        >
                            {status === "loading" ? "Searching Database..." : "Track Order"}
                        </Button>
                    </motion.form>
                )}
            </div>
