...
export function Navbar() {
  ...
  return (
    <>
      ...
      <div
        className="h-[env(safe-area-inset-top)] w-full bg-[#111]"
      ...
      {showBanner ? (
        <Link
          ...
          style={{
            ...bannerStyle,
            backgroundImage: campaign.banner.backgroundImage
              ? `url(${campaign.banner.backgroundImage})`
              : undefined,
        ...
        >
          ...
          {campaign.banner.backgroundImage ? (
            <div className="absolute inset-0 bg-black/40 -z-10"></div>
          ) : null}

          <div
            className={`container mx-auto px-4 h-8 flex items-center justify-center gap-2 text-[10px] md:text-xs font-mono uppercase tracking-widest ${campaign.banner.customCss ? "custom-banner" : ""}`}
          >
            <div
              className={
                theme.animation === "marquee"
                  ? "animate-marquee w-full text-center"
                  : theme.animation === "glitch"
                    ? "animate-glitch"
                    : ""
              }
            >
              <span className="font-bold">{campaign.banner.text}</span>
              <span className="hidden md:inline group-hover:underline ml-2 opacity-80">
                Check it out &rarr;
              </span>
            </div>
          </div>
      ...
      <nav
        className="w-full border-b border-[#222] bg-[#111] z-[10000] sticky top-[env(safe-area-inset-top)] isolate"
        style={{
          backgroundColor: "#111111",
          transform: "translateZ(0)",
      ...
      >
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-8 md:gap-12">
            <Link
              href="/"
              className="flex flex-col leading-none tracking-tighter group"
            >
                  ...
                  >
                    ...
                    {user ? (
                      <>
                        ...
                        <Link
                          href="/profile/me"
                          className="px-4 py-3 text-sm text-gray-400 hover:text-white hover:bg-[#151515] flex items-center gap-3 transition-colors"
                        ...
                        {isAdmin ? (
                          <Link
                            href="/admin"
                            className="px-4 py-3 text-sm text-primary hover:text-white hover:bg-primary/10 flex items-center gap-3 transition-colors border-t border-[#222]"
                            onClick={() => setIsProfileOpen(false)}
                          >
                        ...
                        <button
                          ...
                          className="px-4 py-3 text-sm text-red-500 hover:bg-red-900/20 hover:text-red-400 flex items-center gap-3 transition-colors text-left w-full border-t border-[#222]"
                        >
                      ...
                      <>
                        <button
                          ...
                          className="px-4 py-3 text-sm text-white hover:bg-[#151515] flex items-center gap-3 transition-colors border-b border-[#222] w-full text-left"
                        >
                        ...
                        <button
                          ...
                          className="px-4 py-3 text-sm text-gray-400 hover:text-white hover:bg-[#151515] flex items-center gap-3 transition-colors w-full text-left"
                        >
                          <UserPlus size={14} /> Register
                        </button>
                        <Link
                          href="/orders/lookup"
                          className="px-4 py-3 text-sm text-gray-400 hover:text-white hover:bg-[#151515] flex items-center gap-3 transition-colors border-t border-[#222]"
                          onClick={() => setIsProfileOpen(false)}
                        >
                ...
                {user ? (
                  <>
                    <Link
                      href="/profile/me"
                      onClick={() => setIsMobileMenuOpen(false)}
                      className="text-lg font-mono uppercase text-white flex items-center gap-4"
                    >
                    ...
                    {isAdmin ? (
                      <Link
                        href="/admin"
                        onClick={() => setIsMobileMenuOpen(false)}
                        className="text-lg font-mono uppercase text-primary flex items-center gap-4"
                      >
                    ...
                    <button
                      ...
                      className="text-lg font-mono uppercase text-red-500 flex items-center gap-4"
                    >
                  ...
                  <>
                    <button
                      ...
                      className="text-lg font-mono uppercase text-white flex items-center gap-4 text-left"
                    >
                      <LogIn size={20} /> Login
                    </button>
                    <button
                      ...
                      className="text-lg font-mono uppercase text-gray-400 flex items-center gap-4 text-left"
                    >
                    ...
                    <Link
                      href="/orders/lookup"
                      onClick={() => setIsMobileMenuOpen(false)}
                      className="text-lg font-mono uppercase text-gray-400 flex items-center gap-4"
                    >
